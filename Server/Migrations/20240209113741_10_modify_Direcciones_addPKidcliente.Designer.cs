...
namespace Agapea_Blazor.Server.Migrations
{
    ...
    [Migration("20240209113741_10_modify_Direcciones_addPKidcliente")]
    partial class _10_modify_Direcciones_addPKidcliente
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Agapea_Blazor.Shared.Direccion", b =>
                {
                    ...
                    b.HasKey("IdDireccion", "IdCliente");
            ...
            modelBuilder.Entity("Agapea_Blazor.Shared.Pedido", b =>
                {
                    ...
                    b.Property<string>("DireccionEnvioIdCliente")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("DireccionEnvioIdDireccion")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("DireccionFacturacionIdCliente")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("DireccionEnvioIdDireccion", "DireccionEnvioIdCliente");

                    b.HasIndex("DireccionFacturacionIdDireccion", "DireccionFacturacionIdCliente");
            ...
            modelBuilder.Entity("Agapea_Blazor.Shared.Pedido", b =>
                {
                    b.HasOne("Agapea_Blazor.Shared.Direccion", "DireccionEnvio")
                        .WithMany()
                        .HasForeignKey("DireccionEnvioIdDireccion", "DireccionEnvioIdCliente");

                    b.HasOne("Agapea_Blazor.Shared.Direccion", "DireccionFacturacion")
                        .WithMany()
                        .HasForeignKey("DireccionFacturacionIdDireccion", "DireccionFacturacionIdCliente");
